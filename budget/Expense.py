...
class Expenses():
    ...
    def categorize_set_comprehension(self):
        ...
        return [necessary_expenses, food_expenses, unnecessary_expenses]
        print(timeit.timeit(stmt = 'expenses.categorize_set_comprehension()', setup = 'from.import Expense\\expenses = Expense.Expenses()\\expenses.read_expenses("data/spending_data.csv")', number = 100000, globals=globals()))